...
<html lang="ru">
<head>
    <title>Добавление | Жанры | Администрирование | Starlight</title>
    ...
    <div class='edit-content__div'>
        ...
        <div class='col-md-4'>
            ...
            <div class='col-md-12'>
                ...
                <input id='genre' name='genre' class='col-md-12__input form-control' type='text' value="">
                <p class=''>Описание:</p>
                <textarea class='form-control edit-description'></textarea>
                <button data="/administrator/create/genre" class='btn updateItem btn-more'>Добавить</button>
            </div>
            </div>
        </div>
        <div class='col-md-4'></div>
