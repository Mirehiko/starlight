                ...
                <div class='row'>
                    ...
                    <div class='col-md-7 '>
                        <div class='form-registration'>
                            ...
                            <input id='login' class='form-registration-input'type='text' placeholder='Логин'>
                            <b id='login-ok' class='success'></b><b id='login-error' class='errors'></b>
                            <br>
                            <b>E-mail:</b>
                            <input id='email' class='form-registration-input'type='text' placeholder='vasya@mail.ru'>
                            <b id='email-ok' class='success'></b><b id='email-error' class='errors'></b>
                            <br>
                            <b>Пароль:</b>
                            <input id='password' class='form-registration-input'type='password' >
                            <b id='password-ok' class='success'></b><b id='password-error' class='errors'></b>
                            <br>
                            <b>Повторите пароль:</b>
                            <input id='repassword' class='form-registration-input'type='password' >
                            <b id='repassword-ok' class='success'></b><b id='repassword-error' class='errors'></b>
                            <br>
                            <input type="submit" id='register-btn' class='btn btn-more' value='Регистрация'></button>
